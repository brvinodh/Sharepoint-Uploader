...
namespace MSDN.Samples.ClaimsAuth
{
    ...
    public class ClaimsWebAuth : IDisposable
    {
        ...
        public CookieCollection Show()
        {
            ...
            //var axWebBrowser = (WebBrowser)GetActiveXInstance(this.webBrowser);
            this.webBrowser.NewWindow += AxWebBrowser_NewWindow;
        ...
        private void AxWebBrowser_NewWindow(object sender, System.ComponentModel.CancelEventArgs e)
        {
        ...
        {
            var window = new Form { Width = 400, Height = 300 };
            var newWebBrowser = new WebBrowser();
            window.Controls.Add(newWebBrowser);
            window.Show();
